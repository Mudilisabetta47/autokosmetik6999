...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Autokosmetik & professionelle KFZ-Aufbereitung in Lilienthal: Lackaufbereitung, Innenreinigung, Versiegelung & Komplettpflege. Für Lilienthal, Osterholz-Scharmbeck, Bremen & Umgebung. Preise ab 29 €." },
      { name: "author", content: "Autokosmetik Lilienthal" },
      { name: "robots", content: "index, follow" },
      { property: "og:site_name", content: "Autokosmetik Lilienthal" },
      { property: "og:title", content: "Autokosmetik Lilienthal | KFZ-Aufbereitung Bremen & Osterholz" },
      { property: "og:description", content: "Professionelle Autokosmetik & Fahrzeugaufbereitung in Lilienthal – Lack, Innenraum, Versiegelung. Für Kunden aus Lilienthal, Osterholz-Scharmbeck, Bremen und Umgebung." },
